 ...
 try {
  ...
  pipeline.push({
   $project: {
    ...
    display_order_date: { $dateToString: { date: '$transaction_date', format: "%d %b %Y %I:%M%p" } },
    accepted_date: { $dateToString: { date: '$accepted_date', format: "%d %b %Y %I:%M%p" } },
    shipped_date: { $dateToString: { date: '$shipped_date', format: "%d %b %Y %I:%M%p" } },
    delivered_date: { $dateToString: { date: '$delivered_date', format: "%d %b %Y %I:%M%p" } },
    refunded_date: { $dateToString: { date: '$refunded_date', format: "%d %b %Y %I:%M%p" } },
